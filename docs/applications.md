...
| `observability` | kube-prometheus-stack, grafana, elasticsearch-exporter | Prometheus agent (remote-write to promeo on TrueNAS), Grafana (via grafana-operator), external ES monitoring |
